...
import { iconWrapper, input, inputBox, inputBoxIconWrapper, labelStyle, message } from './styles.css.ts'
    ...
    <div>
      <div className={inputBox}>
        ...
        <div className={iconWrapper}>
          {isEye && <Button size={'sm'} leadingIcon={showIcon} style={'mono'} state={'secondary'} onClick={onEyeToggle} />}
