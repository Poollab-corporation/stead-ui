...
import { guideContainer, labelStyle, requiredMark, textContainer, textStyle, wrapper } from './styles.css.ts'
    ...
    <div className={wrapper}>
      ...
      {guideText && (
        <div className={guideContainer}>
          ...
          <span className={guideText} style={{
            color : state === 'error' ? theme.colors.red500 : theme.colors.neutralGray400
          }}>{guideText}</span>
        </div>
      )}
    </div>
